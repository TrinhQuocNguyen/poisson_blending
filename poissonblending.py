...
def inpainting():
    img = cv2.imread('D:/[PROJECTS]/Edited_PConv-Keras/data/road/GOPR0076/input/raindrop0477.jpg')
    mask = cv2.imread('D:/[PROJECTS]/Edited_PConv-Keras/data/road/GOPR0076/mask/mask_old.jpg', 0)
    ...
    cv2.imwrite("D:/[PROJECTS]/Edited_PConv-Keras/data/road/GOPR0076/cv_inpainting/raindrop0477.jpg", dst)


def alpha_blending():
    # Read the images
    foreground = cv2.imread('D:/tmp/GOPR1031_new_512_blended_02/standard_mask/mask_06.jpg')
    background = cv2.imread('D:/tmp/GOPR1031_new_512_blended_02/input/raindrop_000000.jpg')
    alpha = cv2.imread('D:/tmp/GOPR1031_new_512_blended_02/standard_mask/mask_06.jpg')
...
def alpha_blending_test_copy():
    # Read the images
    foreground = cv2.imread('D:/[PROJECTS]/Edited_PConv-Keras/data/road/fix_lines/ouput/raindrop2261.jpg')
    background = cv2.imread('D:/[PROJECTS]/Edited_PConv-Keras/data/road/fix_lines/input/raindrop2261.jpg')
    alpha = cv2.imread('D:/[PROJECTS]/Edited_PConv-Keras/data/road/fix_lines/mask/mask.jpg')
    ...
    cv2.imshow("src", foreground / 255)
    cv2.imshow("outImg", outImage / 255)
    cv2.imwrite("D:/[PROJECTS]/Edited_PConv-Keras/data/road/fix_lines/alpha/raindrop2261.jpg", outImage)
    cv2.waitKey(0)
...
def seamless_cloning_paper(mode='mixed_clone'):
    ...
    # test seamless cloning
    im = cv2.imread('D:/[PROJECTS]/Edited_PConv-Keras/temp/01.jpg')
    obj = cv2.imread('D:/[PROJECTS]/Edited_PConv-Keras/temp/02.jpg')
    ...
    mask = cv2.imread("D:/[DATA]/mask/mask/testing_mask_dataset/00011.png")
    ...
    # Write results
    # cv2.imwrite("from_pconv/from_pconv.jpg", obj)
    # cv2.imwrite("from_pconv/original.jpg", im)
    #
    # cv2.imwrite("from_pconv/opencv-normal-clone-example.jpg", normal_clone)
    # cv2.imwrite("from_pconv/opencv-mixed-clone-example.jpg", mixed_clone)
    # cv2.imwrite("from_pconv/opencv-monochrome-transfer-example.jpg", monochrome_transfer)
