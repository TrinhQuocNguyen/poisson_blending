...
parser.add_argument('--folder_path', default='D:/104GOPR/', type=str,
...
if __name__ == "__main__":
    ...
    mask = cv2.imread(args.folder_path + "/GOPR0998_proposal_512/mask_detect_02.png")
    ...
    # prcocess images
    img_paths = os.listdir(args.folder_path + "/GOPR0998_proposal_512")
    for img_path in img_paths:
        # Load image
        img = cv2.imread(args.folder_path + "/GOPR0998_proposal_512/" + img_path)
        ...
        cv2.waitKey(30)
        # cv2.imwrite(args.folder_path + "/masked/" + img_path, masked_img)
