...
def main():
    ...
    parser.add_argument('-I1', "--image1", help="Path to the first image", default="data/homography/left02.jpg")
    parser.add_argument('-I2', "--image2", help="Path to the second image", default="data/homography/left01.jpg")
