...
def draw_result_table(img = '', current_frame ='', date_time='', minute_period='',  ttruck_1='', large_1='', small_1='', ttruck_2='', large_2='', small_2='', ttruck_3='', large_3='', small_3=''):
    ...
    content_row_padding = int(content_height / 10)
    ...
    cv2.putText(dest, "1",
                (content_top_left_x + padding * 10, content_top_left_y + content_row_padding * 2 + padding * 4),
                cv2.FONT_HERSHEY_SIMPLEX, 0.5, content_color, 2)
    cv2.putText(dest, "2",
                (content_top_left_x + padding * 10, content_top_left_y + content_row_padding * 5 + padding * 4),
                cv2.FONT_HERSHEY_SIMPLEX, 0.5, content_color, 2)
    cv2.putText(dest, "3",
                (content_top_left_x + padding * 10, content_top_left_y + content_row_padding * 8 + padding * 4),
                cv2.FONT_HERSHEY_SIMPLEX, 0.5, content_color, 2)

    cv2.putText(dest, "T-Truck", (
    content_top_left_x + content_col_padding + padding * 6, content_top_left_y + content_row_padding * 1 + padding * 4),
                cv2.FONT_HERSHEY_SIMPLEX, 0.5, content_color, 2)
    cv2.putText(dest, "Large", (
    content_top_left_x + content_col_padding + padding * 6, content_top_left_y + content_row_padding * 2 + padding * 4),
                cv2.FONT_HERSHEY_SIMPLEX, 0.5, content_color, 2)
    cv2.putText(dest, "Small", (
    content_top_left_x + content_col_padding + padding * 6, content_top_left_y + content_row_padding * 3 + padding * 4),
                cv2.FONT_HERSHEY_SIMPLEX, 0.5, content_color, 2)
    cv2.putText(dest, "T-Truck", (
    content_top_left_x + content_col_padding + padding * 6, content_top_left_y + content_row_padding * 4 + padding * 4),
                cv2.FONT_HERSHEY_SIMPLEX, 0.5, content_color, 2)
    cv2.putText(dest, "Large", (
    content_top_left_x + content_col_padding + padding * 6, content_top_left_y + content_row_padding * 5 + padding * 4),
                cv2.FONT_HERSHEY_SIMPLEX, 0.5, content_color, 2)
    cv2.putText(dest, "Small", (
    content_top_left_x + content_col_padding + padding * 6, content_top_left_y + content_row_padding * 6 + padding * 4),
                cv2.FONT_HERSHEY_SIMPLEX, 0.5, content_color, 2)
    cv2.putText(dest, "T-Truck", (
    content_top_left_x + content_col_padding + padding * 6, content_top_left_y + content_row_padding * 7 + padding * 4),
                cv2.FONT_HERSHEY_SIMPLEX, 0.5, content_color, 2)
    cv2.putText(dest, "Large", (
    content_top_left_x + content_col_padding + padding * 6, content_top_left_y + content_row_padding * 8 + padding * 4),
                cv2.FONT_HERSHEY_SIMPLEX, 0.5, content_color, 2)
    cv2.putText(dest, "Small", (
    content_top_left_x + content_col_padding + padding * 6, content_top_left_y + content_row_padding * 9 + padding * 4),
                cv2.FONT_HERSHEY_SIMPLEX, 0.5, content_color, 2)
    ...
    cv2.putText(dest, ttruck_3, (content_top_left_x + content_col_padding * 3 + padding * 6,
                            content_top_left_y + content_row_padding * 7 + padding * 4), cv2.FONT_HERSHEY_SIMPLEX, 0.5,
                content_color, 2)
    cv2.putText(dest, large_3, (content_top_left_x + content_col_padding * 3 + padding * 6,
                            content_top_left_y + content_row_padding * 8 + padding * 4), cv2.FONT_HERSHEY_SIMPLEX, 0.5,
                content_color, 2)
    cv2.putText(dest, small_3, (content_top_left_x + content_col_padding * 3 + padding * 6,
                            content_top_left_y + content_row_padding * 9 + padding * 4), cv2.FONT_HERSHEY_SIMPLEX, 0.5,
                content_color, 2)
