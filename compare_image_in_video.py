...
def sort_results(results, output=False):
    ...
    for res in sorted_results:
        n += 1
        print
        '#%s\t%s\t%s\t: %s' % (n, res['filename'], res['frame'], res['similarity'])
...
def main():
    ...
    parser.add_argument('-i', '--image', default= 'C:/Users/Trinh/Downloads/couple.png', help='source image')
    parser.add_argument('-v', '--video', default= 'C:/Users/Trinh/Downloads/couple.mp4', help='video to search inside')
    parser.add_argument('-n', '--number', help='number of best matches to return', type=int, default=1)
    parser.add_argument('-b', '--break_point',
                        help='stop searching when frame with [break_point] accuracy found; a number between 0 and 1',
